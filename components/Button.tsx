const Button = ({ onClick, children, variant }: any) => {
  const getButtonStyles = () => {
    switch (variant) {
      ...
      case "secondary":
        return "md:w-48 p-2 md:px-5 md:py-5 text-xs rounded-xl md:text-base bg-[#527794] text-[#0a2140] hover:bg-slate-400 font-bold shadow-2xl transition-all duration-500";
      case "delete":
